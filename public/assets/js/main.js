...
// Function to get the products from the API
const getProducts = async () => {

    const productListElement = document.getElementById('product_list');
    productListElement.innerHTML = `<div class="spinner-container" id="loading">
    <div class="spinner">
     <div class="spinner">
      <div class="spinner">
        <div class="spinner">
    ...
    const cat = document.getElementById('empty');
    if (cat) {
    ...
    try {
        ...
        console.error(error)
        const productListElement = document.getElementById('product_list')
    productListElement.innerHTML = `<div class="empty" id="empty">
    <div class="wrapper">
...
function showProducts() {
    const begin = (pagination - 1) * productsPerPage
    const end = begin + productsPerPage
    const showingProducts = productsToShow.slice(begin, end)
    ...
    showingProducts.forEach(product => {
        ...
        switch (product.page) {
            case "Alkosto":
                imagePage = "assets/img/logo-alkosto.png"
                break;
            case "Exito":
                imagePage = "assets/img/logo-exito.png"
                break;
            case "Falabella":
                imagePage = "assets/img/logo-falabella.png"
                break;
            case "Mercado Libre":
                imagePage = "assets/img/logo-mercado.png"
                break;
            case "Olimpica":
                imagePage = "assets/img/logo-olimpica.png"
                break;
            default:
                break;
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    filterSelect.addEventListener('change', function () {
        ...
        if (selectedFilter === '') {
            ...
            productsToShow = products.filter(product => product.page === selectedFilter);
        }
